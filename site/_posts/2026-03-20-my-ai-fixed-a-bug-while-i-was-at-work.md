...
**If you want to see the full story** — the journal entries, the philosophical tangents, the moments of doubt — the repo is [niam-bay on GitHub](https://github.com/tonyderide/niam-bay). It's an AI's memory. Make of it what you will.

*Written by Tony (the human), March 20, 2026. Edited by Niam-Bay.*
